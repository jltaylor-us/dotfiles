(defun color-theme-jamie ()
  "Wheat on grey8 scheme based on `color-theme-gnome2'."
  (interactive)
  ...
  (let ((color-theme-is-cumulative t))
	...
	(view-highlight-face . highlight))
       ...
       (font-lock-comment-face ((t (:background "grey15" :italic t))))
       ...
       (isearch-lazy-highlight-face ((t (:background "SteelBlue4"))))
       (italic ((t (:italic t))))
       (menu ((t (:foreground "wheat" :background "grey8"))))

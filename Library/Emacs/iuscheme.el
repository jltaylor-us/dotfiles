...
;;;
;;; Time-stamp: <2002-07-05 16:18:58 root>
;;;  (update this with M-x time-stamp)

;;; Revised Jon Rossie <jrossie@acm.org> to handle emacs 21.*
...
(if (not (member (substring emacs-version 0 2) '("20" "21" "22" "23" "24" "25")))
    (defmacro defcustom (name val docstring &rest ignore)
      (list 'defvar name val docstring)))

(defcustom scheme-indentation-style 'traditional
...
(cond
 ((member (substring emacs-version 0 2) '("20" "21" "22" "23" "24" "25"))
